...
public class Vision
{
    ...
    public boolean targetHot()
    {
        ...
        try
        {
            ...
            //image = new RGBImage("/raw.bmp");		// get the sample image from the cRIO flash
            image.write("/raw.bmp");
            BinaryImage thresholdImage = image.thresholdHSV(105, 137, 230, 255, 60, 183);   // keep only green objects
